...
export const FounderOwnerPage = () => {
  ...
  return (
    <div className="bg-[#06070A] text-[#F8F6F0] pt-16 md:pt-20 min-h-screen">
      ...
      {/* 1. HERO HEADER */}
      <section className="relative pt-4 pb-14 md:pt-6 md:pb-20 bg-gradient-to-b from-[#0C0F17] via-[#080A10] to-[#06070A] overflow-hidden">
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-amber-500/[0.05] rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-4xl space-y-6">
            <div className="inline-flex items-center gap-3.5 font-mono text-xs tracking-[0.3em] text-amber-400 uppercase font-semibold">
              ...
              <span>The Founder to Owner Program</span>
            </div>

            <h1 className="text-4xl sm:text-6xl md:text-7xl font-serif font-light text-white leading-[1.08] tracking-tight">
              From doing the work <br />
              <span className="text-stone-400 italic font-normal">to owning the business.</span>
            </h1>
            ...
            <div className="p-4 rounded-lg bg-white/[0.03] border border-white/10 text-xs sm:text-sm font-sans font-light text-stone-300 max-w-2xl">
              We are selective about the founders we work with. The program is structured around small cohorts to ensure the depth of engagement that genuine transformation requires.
            </div>
