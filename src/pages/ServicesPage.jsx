...
export const ServicesPage = () => {
  ...
  return (
    <div className="bg-[#06070A] text-[#F8F6F0] pt-16 md:pt-20 min-h-screen">
      {/* 1. HERO HEADER (LEFT-ALIGNED, FULL VIEWPORT HEIGHT, LUXURY STYLING) */}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full my-auto">
          <div className="max-w-4xl space-y-7 text-left">
            ...
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-serif font-light text-white leading-[1.08] tracking-tight">
              Ten Precision-Engineered <br />
              <span className="text-[#DFC38A] italic font-normal">Leadership Interventions</span>
            </h1>
            ...
            <div className="inline-flex items-center gap-2 p-4 rounded-xl bg-[#0E121E]/80 border border-[#DFC38A]/25 text-xs sm:text-sm font-mono text-stone-200 shadow-lg">
              <span className="text-[#DFC38A] font-bold uppercase tracking-wider">Note:</span>
              <span className="text-stone-300">Investment details are provided during our initial consultation, following a mutual fit assessment.</span>
            </div>
          </div>
        </div>
      </section>
